...
var requestedPage = "http://www.qaworks.com/contact.aspx";
...
//UI step definitions
  ...
  this.Then(/^I should be able to contact QAWorks with the following information$/, function (list,callback) {
      ...
      sendButton.click().then(callback);

       browser.getCurrentUrl().then(function(CurrentUrl) {
             expect(CurrentUrl).to.equal(requestedPage);
